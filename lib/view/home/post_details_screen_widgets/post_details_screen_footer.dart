        ...
        children: [
          Row(
            children: [
              ...
              GestureDetector(
                ...
                child: Icon(
                  heart ? FontAwesomeIcons.solidHeart : FontAwesomeIcons.heart,
                  color: Colors.red,
                ),
              )
            ],
          ...
          TextButton(
            style: const ButtonStyle(
                overlayColor:
                    WidgetStatePropertyAll(Color.fromARGB(255, 137, 188, 230)),
            ...
            child: Text(
                "${translation.comments} (${comments.asData != null ? comments.asData?.value.length : 0})",
                style: const TextStyle(
